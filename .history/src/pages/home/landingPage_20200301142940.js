    ...
    return (
      <View style={Styles.container}>
        ...
        <View style={Styles.loginSection}>
          <View style={[Styles.unameAndPass, Styles[getResponsiveStyle('unameAndPass', styleWidth)]]}>
          ...
          <View style={Styles.loginBtn}>
            <TouchableOpacity onPress={this.onLogin} style={[Styles.loginBtnStyle, Styles[getResponsiveStyle('loginBtnStyle', styleWidth)]]}>
